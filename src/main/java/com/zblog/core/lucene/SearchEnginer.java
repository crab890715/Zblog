...
public final class SearchEnginer {
	 ...
	 * @throws IOException
	 */
	public List<Map<String, Object>> like(int docNum, String[] fields) throws IOException {
	...
	public void searchHighlight(QueryBuilder builder, PageModel<Map<String, Object>> model) {
		searchHighlight(builder, model, null);
	}

	private ScoreDoc lastScoreDoc(IndexSearcher searcher, QueryBuilder builder, PageModel<Map<String, Object>> model)
			throws IOException {
	 ...
	 * @param fields
	 */
	public void searchAfterHighlight(QueryBuilder builder, PageModel<Map<String, Object>> model, Set<String> fields) {
		...
		try {
			...
			for (ScoreDoc sd : docs.scoreDocs) {
				...
				Map<String, Object> mc = DocConverter.convert(doc, builder.getHighlighter());
	 ...
	 */
	public void searchHighlight(QueryBuilder builder, PageModel<Map<String, Object>> model, Set<String> fields) {
		IndexSearcher searcher = null;
		try {
			nmrt.waitForGeneration(reopenToken);
			searcher = manager.acquire();
	 ...
	 * @return
	 */
	private List<Map<String, Object>> search(Query query, int max, Set<String> fields) {
		...
		try {
			...
			for (int i = 0; i < docs.totalHits; i++) {
				...
				Map<String, Object> mc = DocConverter.convert(doc);
				result.add(mc);
			}
