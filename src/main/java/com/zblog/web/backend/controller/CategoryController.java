...
public class CategoryController {
	...
	public Object data() {
		List<Map<String, Object>> list = categoryManager.listAsTree();
		for (Map<String, Object> temp : list) {
			temp.put("text", temp.remove("name"));
			List<Map<String, Object>> nodes = (List) temp.get("nodes");
	...
	public Object insert(Category category, String parent) {
		...
		return Result.success(categoryService.insertChildren(category, parent));
	}
