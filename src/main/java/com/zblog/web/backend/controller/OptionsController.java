...
public class OptionsController {
	...
	public String updateGeneral(GeneralOption form, Model model) {
		...
		Map<String, Object> result = OptionFormValidator.validateGeneral(form);
		if (!result.isEmpty()) {
	...
	public String updatePost(PostOption form, Model model) {
		...
		Map<String, Object> result = OptionFormValidator.validatePost(form);
		if (!result.isEmpty()) {
			model.addAllAttributes(result);
			return "backend/options/post";
		}
	...
	public String updateMail(MailOption form, Model model) {
		Map<String, Object> result = MailFormValidator.validate(form);
