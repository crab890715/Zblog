...
import com.zblog.core.utils.PostTagHelper;
...
public class WordPressManager {
	 ...
	 * @return
	 */
	private Upload importAttach(Map<String, Object> attach, User user, String wpdomain) {
		String attachUrl = (String) attach.get("attachUrl");
		Date pubDate = (Date) attach.get("pubDate");
		InputStream in = null;
		Upload upload = null;
	 ...
	 * @param post
	 */
	private void importPost(Map<String, Object> post, User user, String wpdoamin, Map<String, Upload> links) {
		Post p = new Post();
		...
		Category category = categoryService.loadByName((String) post.get("category"));
		if (category != null) {
		...
		List<String> tags = (List) post.get("tags");
