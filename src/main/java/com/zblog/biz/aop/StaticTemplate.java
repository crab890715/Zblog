...
public class StaticTemplate {
	...
	public void staticHeader() {
		...
		FreeMarkerUtils.doProcessTemplate("/header.html",
				new File(WebConstants.APPLICATION_PATH, WebConstants.PREFIX + "/common/header.html"), map);
	...
	private void staticCloudTags() {
		...
		FreeMarkerUtils.doProcessTemplate("/tagcloud.html",
				new File(WebConstants.APPLICATION_PATH, WebConstants.PREFIX + "/common/tagcloud.html"), map);
	...
	private void staticArchive() {
		...
		FreeMarkerUtils.doProcessTemplate("/archive.html",
				new File(WebConstants.APPLICATION_PATH, WebConstants.PREFIX + "/common/archive.html"), map);
	...
	public void staticLinks() {
		...
		FreeMarkerUtils.doProcessTemplate("/link.html",
				new File(WebConstants.APPLICATION_PATH, WebConstants.PREFIX + "/common/link.html"), map);
	...
	private void staticRecentOrHeader(boolean ispost) {
		if (ispost) {
			Map<String, Object> param = new HashMap<String, Object>() {
				...
				* 
				*/
				private static final long serialVersionUID = 4017925419156141505L;

				{
					put("domain", WebConstants.getDomain());
				}
			};
			param.put("posts", postManager.listRecent(10, PostConstants.POST_CREATOR_ALL));
			FreeMarkerUtils.doProcessTemplate("/recent.html",
					new File(WebConstants.APPLICATION_PATH, WebConstants.PREFIX + "/common/recent.html"), param);
